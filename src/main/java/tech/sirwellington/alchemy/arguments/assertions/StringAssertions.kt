 ...
 */
@NonInstantiable
class StringAssertions @Throws(IllegalAccessException::class)
    ...
    companion object
    {
        ...
        fun stringWithLengthGreaterThanOrEqualTo(minimumLength: Int): AlchemyAssertion<String>
        {
            ...
            return AlchemyAssertion { string: String ->
                ...
                Assertions.notNull<String>().check(string)
        ...
        fun stringWithNoWhitespace(): AlchemyAssertion<String>
        {
            return AlchemyAssertion { string: String ->
                ...
                Assertions.notNull<Any>().check(string)

                string.toCharArray()
                        .filter { it.isWhitespace() }
                        .forEach { throw FailedAssertionException("Argument should not have whitespace.") }
            }
        }
